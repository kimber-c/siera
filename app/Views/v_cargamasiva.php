        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-12 m-auto">
                    <h4><i class="fa fa-building"></i> Estudiantes: Carga masiva</h4>
                </div>
                <div class="col-lg-6 col-sm-6 col-12 m-auto">
                    
                    <a href="<?php echo base_url('estudiante/index');?>" class="btn btn-sm btn-light float-right border shadow">
                        <i class="fa fa-list"></i> 
                        Mostrar estudiantes
                    </a>
                    <a href="<?php echo base_url('cargamasiva/estudiante/cargamasiva_estudiantes.xlsx');?>" class="btn btn-sm btn-info float-right border shadow mr-4">
...
function initDropzone()
{
    myDropzone2 = new Dropzone("#dzLoadFile", {
        url: "<?php echo base_url('estudiante/subirArchivo');?>",
        ...
        renameFile: function(file) {
            return 'cargamasiva_estudiantes.xlsx';
        },
        init:function(){
