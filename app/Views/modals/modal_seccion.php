    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header py-1 border-transparent" style="background-color: rgba(0, 0, 0, 0.03);">
                <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-building"></i> Nueva seccion</h5>
...
{
	return {
        idseccion:$('#identificador').val(),
        descripcion:$('#descripcion').val(),
        idseccionOld:idseccionOld,
	}
}
function segunAccion()
{
    if(nombreAccion == 'registrar')
    {
        ...
        jQuery.ajax(
        {
            url: "<?php echo base_url('seccion/registrar');?>",
            data: data(true),
            method: 'post',
    ...
    else
    {
        ...
        jQuery.ajax(
        {
            url: "<?php echo base_url('seccion/actualizar');?>",
            data: data(true),
            method: 'post',
            success: function(result){
...
function consultar(elem)
{
    jQuery.ajax(
    {
        url: "<?php echo base_url('seccion/consultar');?>",
        data: {id:$(elem).attr('data-id')},
        method: 'post',
        success: function(r){
            console.log(r);
            let data = JSON.parse(r);
            idseccionOld=data.idseccion;
            $('#identificador').val(data.idseccion);
