    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header py-1 border-transparent" style="background-color: rgba(0, 0, 0, 0.03);">
                <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-building"></i> Nueva Ugel</h5>
...
{
    return {
        idejecutora:$('#identificador').val(),
        descripcion:$('#descripcion').val(),
        idejecutoraOld:idejecutoraOld,
    }
}
function segunAccion()
{
    if(nombreAccion == 'registrar')
    {
        ...
        jQuery.ajax(
        {
            url: "<?php echo base_url('ejecutora/registrar');?>",
            data: data(true),
            method: 'post',
    ...
    else
    {
        ...
        jQuery.ajax(
        {
            url: "<?php echo base_url('ejecutora/actualizar');?>",
            data: data(true),
            method: 'post',
            success: function(result){
...
function consultar(elem)
{
    jQuery.ajax(
    {
        url: "<?php echo base_url('ejecutora/consultar');?>",
        data: {id:$(elem).attr('data-id')},
        method: 'post',
        success: function(r){
            console.log(r);
            let data = JSON.parse(r);
            idejecutoraOld=data.idejecutora;
            $('#identificador').val(data.idejecutora);
