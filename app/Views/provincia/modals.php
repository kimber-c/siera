<div class="modal fade" id="modalSeccion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header py-1 border-transparent" style="background-color: rgba(0, 0, 0, 0.03);">
                <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-building"></i> Nueva provincia</h5>
...
{
	return {
        idprovincia:$('#identificador').val(),
        descripcion:$('#descripcion').val(),
        idprovinciaOld:idprovinciaOld,
	}
}
function segunAccion()
{
    if(nombreAccion == 'registrar')
    {
        ...
        jQuery.ajax(
        {
            url: "<?php echo base_url('provincia/registrar');?>",
            data: data(true),
            method: 'post',
    ...
    else
    {
        ...
        jQuery.ajax(
        {
            url: "<?php echo base_url('provincia/actualizar');?>",
            data: data(true),
            method: 'post',
            success: function(result){
...
function consultar(elem)
{
    jQuery.ajax(
    {
        url: "<?php echo base_url('provincia/consultar');?>",
        data: {id:$(elem).attr('data-id')},
        method: 'post',
        success: function(r){
            console.log(r);
            let data = JSON.parse(r);
            idprovinciaOld=data.idprovincia;
            $('#identificador').val(data.idprovincia);
